...
// chạy từ phần tử cuối về đầu để lấy sản phẩm mới mất ở cuối
    ...
    <div class="product-img">
      ...
      <div  class="product-action">
        <button href="" class="btn_view">
         ...
         <button id="${product.product_id}" class="btn_cart">
...
productContainerAll.addEventListener("click", function (event) {
    ...
    <li class="danhmuc-item">
                <div class="row">
                  ...
                  <div class="product-info col-7 pl-0">
                    <h6><a id="${product.product_id}" class="product-name" href="#">${product.product_name}</a></h6>
                    <div class="price">
                      <span class="price-new">${product.unit_price}đ</span>
                    </div>
                  </div>
...
//chức năng xem chi tiết nổi bật
// gán sự kiện click cho toàn bộ nội dung sp nổi bật
containerBanh.addEventListener("click", function (event) {
  // Lấy ra thẻ đã được click
